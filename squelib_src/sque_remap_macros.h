...
#define SQUE_COLOR_BIT			GL_COLOR_BUFFER_BIT
#define SQUE_DEPTH_BIT			GL_DEPTH_BUFFER_BIT
...
#endif
// Framebuffer
#define SQUE_DRAW_FBO	GL_DRAW_FRAMEBUFFER
#define SQUE_READ_FBO	GL_READ_FRAMEBUFFER
#define SQUE_FBO		GL_FRAMEBUFFER
#define SQUE_COLOR_ATTACHMENT0 GL_COLOR_ATTACHMENT0
// Texture Locators
...
#define SQUE_FVEC2		GL_FLOAT_VEC2
#define SQUE_FVEC3		GL_FLOAT_VEC3
#define SQUE_FVEC4		GL_FLOAT_VEC4
#define SQUE_FMAT4		GL_FLOAT_MAT4
#define SQUE_SAMPLER2D	GL_SAMPLER_2D
//... keep adding, not good but eh
// Texture Types
#define SQUE_RGBA   GL_RGBA
#define SQUE_RGBA8  GL_RGBA8
#define SQUE_R8     GL_R8
#define SQUE_R16    GL_R16
#define SQUE_RGB    GL_RGB
#define SQUE_RGB8   GL_RGB8
#define SQUE_TYPE_DEPTH GL_DEPTH_ATTACHMENT
#define SQUE_DEPTH16	GL_DEPTH_COMPONENT16
#define SQUE_DEPTH24	GL_DEPTH_COMPONENT24
#define SQUE_DEPTH32	GL_DEPTH_COMPONENT32
#define SQUE_DEPTH32F	GL_DEPTH_COMPONENT32F
// Texture Parameters
#define SQUE_MIP_MAX_LEVEL      GL_TEXTURE_MAX_LEVEL
#define SQUE_MIP_MIN_LEVEL      GL_TEXTURE_BASE_LEVEL
...
// MOUSE MODE
#define SQUE_MOUSE_DEFAULT			GLFW_MOUSE_NORMAL
#define SQUE_MOUSE_INVISIBLE		GLFW_MOUSE_HIDDEN
#define SQUE_MOUSE_DISABLED			GLFW_MOUSE_DISABLED
// CONTEXT HINTS
...
#define SQUE_CONTEXT_MAJOR_MAX			4
#define SQUE_CONTEXT_MINOR_MIN			3
#define SQUE_CONTEXT_MINOR_MAX			6
#define SQUE_DEBUG_CONTEXT			GLFW_OPENGL_DEBUG_CONTEXT
// BUFFER HINTS
...
#define SQUE_CONTEXT_MAJOR_MIN		    3
#define SQUE_CONTEXT_MAJOR_MAX			3
#define SQUE_CONTEXT_MINOR_MIN			SQUE_INVALID
#define SQUE_CONTEXT_MINOR_MAX			SQUE_INVALID
#define SQUE_DEBUG_CONTEXT				SQUE_INVALID
// BUFFER HINTS

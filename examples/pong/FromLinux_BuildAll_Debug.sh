...
konsole --noclose -e cmake ../ -DCMAKE_TOOLCHAIN_FILE=/home/marcfly/Documents/SqueLib/SqueLib.toolchain -DANDROID_VERSION=29 -DWITH_GLMATH=ON -DWITH_SOLOUD=ON -UToLinux -DToAndroid=1 -DCMAKE_BUILD_TYPE=Debug -DNDK_DEBUG=1

...
macro(SqueLib_Package asset_folder resource_folder)
    ...
    elseif(ToLinux)
        execute_process(COMMAND cp -a ${own_asset}/. ${SqueLib_Output})
        execute_process(COMMAND cp -a ${own_resource}/.   ${SqueLib_Output})
    elseif(ToWindows)
        execute_process(COMMAND robocopy ${own_asset} ${SqueLib_Output}/${CMAKE_BUILD_TYPE})
        execute_process(COMMAND robocopy ${own_resource} ${SqueLib_Output}/${CMAKE_BUILD_TYPE})
    endif()
endmacro()